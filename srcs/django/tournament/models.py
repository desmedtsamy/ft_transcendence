...
class Tournament(models.Model):
	...
	def set_start_tournament(self):
		if not self.is_started:
			...
			self.save()
			print(f"Le tournoi {self.name} a commencé !")
...
class TournamentMatch(models.Model):
	...
	match = models.OneToOneField("pong.Match", on_delete=models.CASCADE, null=True, blank=True, related_name='tournament_match')